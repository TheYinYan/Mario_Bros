...
ground = Entity(model="quad", scale=(40,1,1), position=(0,-2), collider="cube", texture="grass")
ground = Entity(model="quad", scale=(24,1,1), position=(40,-2), collider="cube", texture="grass")
...
enemy = Entity(model="quad", color = color.clear, scale =(1,1), position = (1,-1), collider = "cube",)
enemy2 = Entity(model="quad", color = color.clear, scale =(1,1), position = (-10,7), collider = "cube", visible =False)
...
lucky4 = Entity(model='cube', scale=(1,1,1), position=(1,7), collider='cube', texture="assets/lucky.jpeg")

tuberia = Entity(model='cube', scale=(2,2,1), position=(8.5,-0.5), collider='cube', texture="assets/tuberia.png")
...
champiñon = Entity(model='cube', scale=(1,1,2),position=(6,2), collider='cube', texture="assets/champiñon.png",visible=False)
champiñon2 = Entity(model='cube', scale=(1,1,2),position=(14,2), collider='cube', texture="assets/champiñon.png",visible=False)
...
def update():
    ...
    if champiñon.y >= -0.88 and hitlucky == 0 and champiñon.x >= 3.7:
    ...
    if champiñon2.y >= -0.88 and hitlucky5 == 0 and champiñon2.x >= 15.7:
