...
ground = Entity(model="quad", scale=(40,1,1), position=(0,-2.1), collider="quad", texture="grass")
ground = Entity(model="quad", scale=(100,1,1), position=(75,-2.1), collider="quad", texture="grass")
...
enemy2 = Entity(model="quad", color = color.clear, scale =(1,1), position = (-10,8), collider = "cube", visible =False)
