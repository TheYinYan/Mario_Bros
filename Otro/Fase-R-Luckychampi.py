...
player = PlatformerController2d( x=-9.5, y=1, z=0, scale_y=1, scale_z=1, max_jumps=2, color = color.clear, 
                                
                                jump_height = 4.3, gravity = 0.5, jump_duration = 0.6, air_time = 0, collider = 'box')
...
champiñon = Entity(model='quad', scale=(1,1,1), collider='quad', texture="assets/champiñon.png",visible=False)
champiñon2 = Entity(model='quad', scale=(1,1,1), collider='quad', texture="assets/champiñon.png",visible=False)
champiñon3 = Entity(model='quad', scale=(1,1,1), collider='quad', texture="assets/champiñon.png",visible=False)
...
def update():
    ...
    if champiñon3.y >= -0.9 and hitlucky10 == 0 and champiñon3.x >= 15.7:
    ...
    if champiñon3.x <= 9.8 or champiñon3.x >= 19:
    ...
    if player.intersects(lucky).hit and hitlucky == 1  and held_keys['space']:
    ...
    if player.intersects(lucky).hit and hitlucky == 1 and held_keys['s']:
        
        lucky.texture = "assets/lucky_off.png"

        champiñon.position=(0,1)
        champiñon_speed = 1.5
        champiñon.visible = True
    ...
    if player.intersects(lucky2).hit and hitlucky2 == 1 and held_keys['s'] or player.intersects(lucky2).hit and hitlucky2 == 1  and held_keys['space']:
    ...
    if player.intersects(lucky3).hit and hitlucky3 == 1 and held_keys['s'] or player.intersects(lucky3).hit and hitlucky3 == 1  and held_keys['space']:
    ...
    if player.intersects(lucky4).hit and hitlucky4 == 1 and held_keys['s'] or player.intersects(lucky4).hit and hitlucky4 == 1  and held_keys['space']:
    ...
    if player.intersects(lucky5).hit and hitlucky5 == 1  and held_keys['s'] or player.intersects(lucky5).hit and hitlucky5 == 1  and held_keys['space']:
    ...
    if player.intersects(lucky6).hit and hitlucky6 == 1  and held_keys['s'] or player.intersects(lucky6).hit and hitlucky6 == 1  and held_keys['space']:
    ...
    if player.intersects(lucky7).hit and hitlucky7 == 1  and held_keys['s'] or player.intersects(lucky7).hit and hitlucky7 == 1  and held_keys['space']:
    ...
    if player.intersects(lucky8).hit and hitlucky8 == 1  and held_keys['s'] or player.intersects(lucky8).hit and hitlucky7 == 1  and held_keys['space']:
    ...
    if player.intersects(lucky9).hit and hitlucky9 == 1  and held_keys['s'] or player.intersects(lucky9).hit and hitlucky9 == 1  and held_keys['space']:
    ...
    if player.intersects(lucky10).hit and hitlucky10 == 1  and held_keys['s'] or player.intersects(lucky10).hit and hitlucky10 == 1  and held_keys['space']:
