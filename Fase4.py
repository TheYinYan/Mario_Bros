...
player = PlatformerController2d( x=-9, y=1, z=0, scale_y=1, scale_z=1, max_jumps=3, color = color.clear)
...
def update():
    ...
    champiñon.y -= gravity * time.dt

    if champiñon.y >= -0.88 and hitlucky == 0 and champiñon.x >= 7.7:
