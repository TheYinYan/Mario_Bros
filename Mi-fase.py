...
player = Entity(model="quad", texture="assets/Mario1.png", scale=(1.4,1.4,1), position=(-0.5,-0.8),visible=True, collider ="box")
...
bloque = Entity(model='cube', scale=(1,1,1), position=(6, 6), collider='cube', texture="assets/bloque.png")
bloque = Entity(model='cube', scale=(1,1,1), position=(7, 6), collider='cube', texture="assets/bloque.png")
bloque = Entity(model='cube', scale=(1,1,1), position=(8, 6), collider='cube', texture="assets/bloque.png")
bloque = Entity(model='cube', scale=(1,1,1), position=(9, 6), collider='cube', texture="assets/bloque.png")
bloque = Entity(model='cube', scale=(1,1,1), position=(10, 6), collider='cube', texture="assets/bloque.png")

bloque = Entity(model='cube', scale=(1,1,1), position=(5, 2), collider='cube', texture="assets/bloque.png")
lucky = Entity(model='cube', scale=(1,1,1), position=(6, 2), collider='cube', texture="assets/lucky.jpeg")
bloque = Entity(model='cube', scale=(1,1,1), position=(7, 2), collider='cube', texture="assets/bloque.png")
# Camara
...
# Gravedad
    ...
    if player.intersects(ground or lucky or bloque).hit:
