...
duplicate(bg, x=43),duplicate(bg, x=50),duplicate(bg, x=80),duplicate(bg, x=100),duplicate(bg, x=110),duplicate(bg, x=-30)

ground = Entity(model="quad", scale=(40,1,1), position=(0,-2.1), collider="cube", texture="grass")
ground2 = Entity(model="quad", scale=(100,1,1), position=(73.7,-2.1), collider="cube", texture="grass")
...
duplicate(bloque,x=16,y=6),duplicate(bloque,x=17,y=6), duplicate(bloque,x=18,y=6), duplicate(bloque,x=19,y=6), duplicate(bloque,x=20,y=6), duplicate(bloque,x=21,y=6), duplicate(bloque,x=22,y=6)

duplicate(bloque,x=28,y=6), duplicate(bloque,x=29,y=6), duplicate(bloque,x=30,y=6), duplicate(bloque,x=31,y=6)
...
duplicate(bloque,x=58,y=6), duplicate(bloque,x=59,y=6), duplicate(bloque,x=60,y=6), duplicate(bloque,x=61 ,y=6)
...
duplicate(bloque,x=66), duplicate(bloque,x=67)
...
def update():
    global is_game_over, enemy_speed, enemy2_speed, is_you_win, is_up_flor, bola_fuego_speed, hitflorfuego, champiñon_speed, hitchampiñon, champiñon_gravity, champiñon2_speed, hitchampiñon2
    
    global champiñon2_gravity, champiñon3_speed, hitchampiñon3, champiñon3_gravity, score, Time, hitBandera, time2, num_life,hitlucky, hitlucky2, hitlucky3, hitlucky4, hitlucky5, hitlucky6

    global hitlucky7, hitlucky8, hitlucky9, hitlucky10, hitlucky11, hitlucky12, hitbloque_moneda
    ...
    if champiñon3.y >= -0.93 and hitlucky10 == 0 and champiñon3.x >= 46.5:

        champiñon3_gravity += 0.92
    ...
    if  player.intersects(Bandera2).hit and hitBandera == 1:
    ...
    if player.intersects(Bandera).hit and hitBandera == 1:
    ...
    if player.intersects(Bandera1).hit and hitBandera == 1:
...
def input(key):
    ...
    global is_game_over, is_you_win, hitBandera, Time, score, num_life, hitlucky, hitlucky2, hitlucky3, hitlucky4, hitlucky5, hitlucky6, hitlucky7, hitlucky8, hitlucky9, hitlucky10, hitlucky11, hitlucky12

    global champiñon_speed, hitchampiñon, champiñon2_speed, hitchampiñon2, champiñon3_speed, hitchampiñon3, hitflorfuego, bola_fuego_speed, is_up_flor, hitbloque_moneda
