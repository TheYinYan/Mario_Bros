...
scocer_text =Text(text="Score:", scale=1.4, position=(-0.81, 0.4), color = color.yellow, font = 'assets/GrapeSoda.ttf'  )
Time_text =Text(text="Time:", scale=1.4, position=(0.66, 0.46), color = color.yellow, font = 'assets/GrapeSoda.ttf'  )
...
def update():
    ...
    if  player.intersects(Bandera2).hit and hitBandera == 1 :
        ...
        Time_text2.text = f'En un tiempo de {int(time2)}'
        scocer_text2.text = f'Tu puntuacion es de {score}'
