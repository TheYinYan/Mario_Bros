...
player = PlatformerController2d( x=2, y=2, z=0, scale_y=1, scale_z=1, max_jumps=3, color = color.clear)
...
#  Vida contador 
    ...
    if player.intersects(lucky).hit:
    ...
    if player.intersects(lucky2).hit:
